...
class TagTemplate extends React.Component {
  render() {
    ...
    return (
      <Layout>
        <div>
          <Helmet htmlAttributes= {{lang: 'en'}}  title={`All Articles tagged as "${tagTitle}" - ${title}`} />
          <Sidebar />
...
export const pageQuery = graphql`
  query TagPage($tagCodename: String) {
    ...
    allKontentItemArticle(
      filter: {elements: {tags: {value: {elemMatch: {system: {codename: {eq: $tagCodename}}}}}}, preferred_language: {eq: "en-US"}}
